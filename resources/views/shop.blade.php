                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class=" image card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="{{ asset($product->image) }}" alt="{{ $product->name }}">
                            ...
                            <div class="card-body">
                              <div class="description">
                                ...
                                <price class="text-center mb-0">{{ Number::currency($product->price)}}</price>
                                <a class="btn btn-warning btn-sm float-end" href="{{ route('addcart.cart', $product->id) }}">Add Cart</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
